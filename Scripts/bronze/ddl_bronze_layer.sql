...
Script Purpose:
This script creates tables in the bronze schema dropping existing tables if they are already exist.
Run this script to redifine the DDL structure of the 'broze' Tables.
*/
...
-- To list tables in the bronze schema, use this:
